<template>
  <form @submit.prevent="submitForm">
    ...
    <!-- for single checkboxes you don't have to provide a value, the v-model directive should be associated with the name, and depending on whether or not it's checked, will return a boolean -->
    <div class="form-control">
